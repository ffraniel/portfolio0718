...
const About = (props) => (
        <section className="introduction" >
            <article>
                ...
                <p>I love to develop beautiful <span>responsive</span> websites and use exciting technology but the bottom line is how <span>effective</span> the website or service is at satisfying the users. I like to keep that in mind at all times no matter what i am developing in order to give <span>consistently great user experience.</span></p>
            </article>
